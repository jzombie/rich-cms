...
This site is a static site generator that I hand-rolled: A basic Python script that "compiles" a recursive directory structure mostly consisting of markdown files (don't diss the source-code too hard; my Python skills aren't as well-versed as say, my JavaScript skills, but I didn't want to create a Node.js project for this site).
